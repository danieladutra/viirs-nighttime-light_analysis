...
#Aplicação: Análise de séries temporais de radiância de luzes noturnas no Município de Canoas- Estado do Rio Grande do Sul- Brasil (abril/maio/junho 2024)
...
def plot_time_series(jd, dnb_value3, dnb_value1):
    ...
    plt.title('Série Temporal de NTL - Canoas, RS (Bairro Rio Branco)')
    #plt.title('Série Temporal de NTL - Canoas, RS (Bairro Mathias Velho)')
    #plt.title('Série Temporal de NTL - Canoas, RS (Bairro Fátima)')
    #plt.title('Série Temporal de NTL - Canoas, RS (Bairro Niteroi)')
    #plt.title('Série Temporal de NTL - Canoas, RS (Bairro Centro)')
    #plt.title('Série Temporal de NTL - Canoas, RS (Bairro Harmonia)')
    ...
    plt.title('Tabela de Valores da Série Temporal - Canoas, RS (Bairro Rio Branco)')
    #plt.title('Tabela de Valores da Série Temporal - Canoas, RS (Bairro Mathias Velho)')
    #plt.title('Tabela de Valores da Série Temporal - Canoas, RS (Bairro Fátima)')
    #plt.title('Tabela de Valores da Série Temporal - Canoas, RS (Bairro Niteroi)')
    #plt.title('Tabela de Valores da Série Temporal - Canoas, RS (Bairro Centro)')
    #plt.title('Tabela de Valores da Série Temporal - Canoas, RS (Bairro Harmonia)')
...
input_folder = "C:/Users/Clima/Downloads/LAACS/Canoas RS/Data_CN4"
...
lat, lon = -29.9626, -51.1911  # Canoas-RS Bairro Rio Branco
#lat, lon = -29.9098, -51.2054 #Canoas-RS Bairro Mathias Velho
#lat, lon = -29.9488, -51.1910 #Canoas-RS Bairro Fatima
#lat, lon = -29.9629, -51.1685 #Canoas-RS Bairro Niteroi
#lat, lon = -29.9099, -51.1905 #Canoas-RS Bairro Centro
#lat, lon = -29.9133, -51.2166 #Canoas-RS Bairro Harmonia
...
excel_file = os.path.join(output_folder, "Serie_Temporal_NTL_Canoas_RS_Bairro Rio Branco.xlsx")
#excel_file = os.path.join(output_folder, "Serie_Temporal_NTL_Canoas_RS_Bairro Mathias Velho.xlsx")
#excel_file = os.path.join(output_folder, "Serie_Temporal_NTL_Canoas_RS_Bairro Fátima.xlsx")
#excel_file = os.path.join(output_folder, "Serie_Temporal_NTL_Canoas_RS_Bairro Niteroi.xlsx")
#excel_file = os.path.join(output_folder, "Serie_Temporal_NTL_Canoas_RS_Bairro Centro.xlsx")
#excel_file = os.path.join(output_folder, "Serie_Temporal_NTL_Canoas_RS_Bairro Harmonia.xlsx")
